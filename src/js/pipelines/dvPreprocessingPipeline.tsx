    ...
    return {
        ...
        inputs: [
            ...
            },
            {
                key:keys.mask,
                title:'Cell Outlines',
                description:'The cell outline file generated by cell detector pipeline (*.mask extension). Alternatively can be a binary PNG with white areas corresponding to cell outlines. The binary mask method is less precise, but the mask can be generated with any software and easily corrected with a graphics tool.',
