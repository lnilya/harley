...
def __getBatchData(session:SessionData, modulesById:Dict[str, ModuleBase]):
...
def appendToCellSet(destinationPath:str,data:SessionData, modulesById:Dict[str, ModuleBase], batchNum:int):
    ...
    curData['data'][batchNum] = __getBatchData(data,modulesById)
